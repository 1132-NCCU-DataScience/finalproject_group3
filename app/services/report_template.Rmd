...
# 熱力圖使用 iframe 嵌入，指向相對路徑
heatmap_filename <- params$heatmap_plot  # 例如 "coverage_heatmap.html"
if (file.exists(abs_heatmap_path)) {
  cat(paste0('<iframe src="', heatmap_filename, '" width="100%" height="600px" frameborder="0"></iframe>'))
} else {
  cat("覆蓋熱力圖檔案未找到。")
}
```
